...
export default async function MeltSlowSmokedBarbecuePage({ params }: { params: Promise<{ slug: string }> }) {
  const resolvedParams = await params
  const restaurant = restaurants.find(r => r.name === "Melt Slow Smoked Barbecue")
