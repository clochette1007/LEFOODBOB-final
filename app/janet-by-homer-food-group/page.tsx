...
export default async function JanetByHomerFoodGroupPage({ params }: { params: Promise<{ slug: string }> }) {
  const resolvedParams = await params
  const restaurant = restaurants.find(r => r.name === "Janet by Homer Food Group")
