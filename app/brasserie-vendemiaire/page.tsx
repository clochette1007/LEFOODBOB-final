...
export default async function BrasserieVendemiairePage({ params }: { params: Promise<{ slug: string }> }) {
  const resolvedParams = await params
  const restaurant = restaurants.find(r => r.name === "Brasserie Vendémiaire")
